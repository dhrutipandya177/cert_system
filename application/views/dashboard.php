            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"><?php echo $_SESSION['user_name']; ?></h3>
                            ...
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    <div class="d-inline-flex align-items-center">
                                        ...
                                        <h2 class="text-dark mb-1 font-weight-medium">1500+</h2>
                                       <!--  <span
                                            ...
                                            <tr>
                                                <td class="border-top-0 px-2 py-4">
                                                    <div class="d-flex no-block align-items-center">
                                                        <div class="mr-3"><img
                                                                src="<?php echo base_url(); ?>dist/img/<?php echo $_SESSION['user_image']; ?>"
                                                                alt="user" class="rounded-circle" width="45"
                                                                height="45" /></div>
                                                        <div class="">
                                                            <h5 class="text-dark mb-0 font-16 font-weight-medium">
                                                                <?php echo $_SESSION['user_name']; ?></h5>
                                                            <span class="text-muted font-14"><?php echo $_SESSION['user_email']; ?></span>
                                                        </div>
                                                    </div>
                                                </td>
